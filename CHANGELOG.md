...
- fixture-backed end-to-end flash and recovery coverage
- releasing workflow documentation and AGENTS.md guidance
...
- narrow prompt-based XMODEM recovery to only tolerate EOT
  completion failures
...
- release-plz workflow restored to canonical single-file design
  with fetch-tags for git_only version detection
